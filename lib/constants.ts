...
'Hi [name]! Welcome to the Cuemath tutor screening. I am going to ask you a few questions about teaching and working with kids. Just a heads-up: after you finish speaking, please wait for 5 seconds and your answer will be submitted automatically. Also, beware — if you do not say anything for 10 seconds, the system will assume you want to move to the next question. There are no trick questions — just be yourself and answer naturally. Let us get started. Tell me a little about yourself — what is your background and what interests you about tutoring? [Q1]'
